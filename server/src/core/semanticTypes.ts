...
export const DATA_TYPE_DEFINITIONS: DataTypeDefinition[] = [
  ...
  },
  {
    ...
    description: 'Street number only.\nExample: 6449',
    groups: ['Location'],
  },
  {
    value: 'streetSuffix',
  ...
  {
    value: 'productGrocery',
    displayName: 'Product (Grocery)',
    description: 'Grocery product name.\nExample: Tomato - Green',
    groups: ['Products'],
  },
  {
    value: 'productName',
  ...
  {
    value: 'mobileDeviceBrand',
    displayName: 'Mobile Device Brand',
    description: 'Mobile brand name.\nExample: Samsung',
    groups: ['Products'],
  },
  {
    value: 'mobileDeviceModel',
    displayName: 'Mobile Device Model',
    description: 'Mobile model name.\nExample: Galaxy S5',
    groups: ['Products'],
  },
  {
    value: 'mobileDeviceOs',
    displayName: 'Mobile Device OS',
    description: 'Mobile operating system.\nExample: Android',
    groups: ['Products'],
  },
  {
    value: 'mobileDeviceReleaseDate',
    displayName: 'Mobile Device Release Date',
    description: 'Mobile release year.\nExample: 2015',
    groups: ['Products'],
  },
  {
    value: 'movieGenres',
